...
class units_menu : Fragment() {
    ...
    private var _binding: FragmentUnitsMenuBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentUnitsMenuBinding.inflate(inflater, container, false)
        return binding.root
    ...
    // Uses a string as input, parses it between available units
    // Shows a toast if user doesn't have enough gold to buy an upgrade for unit
